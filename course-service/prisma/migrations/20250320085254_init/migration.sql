-- CreateEnum
CREATE TYPE "CourseAccess" AS ENUM ('FREE', 'PAID', 'PRIVATE');

-- CreateEnum
CREATE TYPE "LessonType" AS ENUM ('LESSON', 'QUIZ');
...
CREATE TABLE "Course" (
    ...
    "accessType" "CourseAccess" NOT NULL DEFAULT 'FREE',
...
-- AddForeignKey
ALTER TABLE "Course" ADD CONSTRAINT "Course_spaceId_fkey" FOREIGN KEY ("spaceId") REFERENCES "Space"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
